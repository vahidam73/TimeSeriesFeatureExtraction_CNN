...
# define model
model = Sequential()
model.add(Conv1D(filters=24, kernel_size=10, activation='relu', input_shape=(look_back, n_features)))
...
#history = model.fit(train_X, train_y, epochs=50, batch_size=96, validation_data=(test_X, test_y), verbose=1, shuffle=False)
